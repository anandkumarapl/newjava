...
public class Utilities {
    public static String getTodoList() {
        try {
            ...
            PreparedStatement ps = DbConnect.connect().prepareStatement("select   serialno,task,description,taskstatus,to_char(taskdate,'dd-Mon-yyyy') as taskdate from todo order by serialno desc");
