...
public class Utilities {
    public static String getTodoList() {
        try {
            ...
            PreparedStatement ps = DbConnect.connect().prepareStatement("select   serialno,task,description,status,taskdate,to_char(taskdate,'dd-Mon-yyyy-hh24:mi') as taskdate from todo order by serialno desc");
