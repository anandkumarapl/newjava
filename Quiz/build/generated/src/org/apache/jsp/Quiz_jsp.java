...
//                        Result = "records" + "Founded"+count;
      ...
      out.print(OPTION1);
      out.write("<input required class=\"form-check-input\" type=\"radio\" name=\"option\" value=\"1\"></label></td><td class=\"form-control\"><label class=\"form-control form-check-label\">");
      out.print(OPTION2);
      out.write("<input required type=\"radio\" name=\"option\" value=\"2\"></label></td></tr>\n");
      out.write("                                <tr><td class=\"form-control\"><label class=\"form-control form-check-label\">");
      out.print(OPTION3);
      out.write("<input required type=\"radio\" name=\"option\" value=\"3\"></label></td><td class=\"form-control\"><label class=\"form-control for\">");
      out.print(OPTION4);
