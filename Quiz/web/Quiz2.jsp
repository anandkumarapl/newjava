            ...
            <div class="row">
                ...
                <div class="col-8"> <div class="option"><table width='100%' border='2'>
                            <tr><td><label class="form-control form-check-label"><div class="trs"><%=OPTION1%>
                                            <input <%=style%> required class="form-check-input" type="radio" name="option" value="1"></label></div></td>

                                <td><label class="form-control form-check-label"><div class="trs"><%=OPTION2%><input  <%=style%>   class="form-check-input" required type="radio" name="option" value="2"></label></div></td></tr>
                            <tr><td><label class="form-control form-check-label"><div class="trs"><%=OPTION3%>
                                            <input  <%=style%>   class="form-check-input" required type="radio" name="option" value="3"></label></div></td>
                                <td><label class="form-control for"><div class="trs"><%=OPTION4%>
                                            <input  <%=style%>  required type="radio"  class="form-check-input" name="option" value="4"></label></div></td>
